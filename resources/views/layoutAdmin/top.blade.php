        ...
        <div class="topbar">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <form>
                        ...
                        <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top"
                            style="background-image: url({{ asset('layoutAdmin/media/misc/bg-1.jpg') }})">
                            <!--begin::Title-->
                                ...
                                <div class="scroll pr-7 mr-n7" data-scroll="true" data-height="300"
                                    ...
                                    <div class="d-flex align-items-center mb-6">
                                        ...
                                        <div class="d-flex flex-column font-weight-bold">
                                            <a href="#"
                                                class="text-dark text-hover-primary mb-1 font-size-lg">Briviba SaaS</a>
            ...
            <div class="topbar-item">
                <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2"
                    ...
                    <a href="{{route('account')}}"><span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3" id="nameAccount">...</span></a>
                    <span class="symbol symbol-35 symbol-light-success">
                        <span class="symbol-label font-size-h5 font-weight-bold"><img width="22px" height="22px" src="{{ asset('layoutLogin/images/logo.webp') }}"></span>
                    </span>
                </div>
            </div>
            <!--end::User-->

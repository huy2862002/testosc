        ...
        $(function() {
            ...
            function HandleData(data) {
                ...
                let html = data.map(function(value, key) {
                    ...
                    return `
                <tr>
                <td>${value[0].EmployeeID}</td>
                <td>${value[0].FirstName}</td>
                <td>${value[0].LastName}</td>
                <td>${value[0].Department}</td>
                <td>${value[0].Designation}</td>
                <td>${value[0].Date_of_birth}</td>
                <td>${value[0].Role}</td>
                <td>${value[0].Mobile}</td>
                <td>${value[0].Address}</td>
                <td>
                <a class="btn-confirm" data-title="Are you sure you want to delete this record ?" title="Delete" style="margin-right: 1px; cursor: pointer" data-url=""><span class="svg-icon svg-icon-danger svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/Files/Deleted-file.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <a title="Update" href=""><span class="svg-icon svg-icon-warning svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/Design/Pen-tool-vector.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <rect x="0" y="0" width="24" height="24"/>

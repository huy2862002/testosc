        ...
        <div class="card card-custom">
            ...
            <div class="card-body" style="display: grid;grid-template-columns:1fr 1fr;grid-gap:20px">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input disabled class="form-control line_i" name="AddedBy" type="text"
                            value="{{ $department['AddedBy'] }}" />

                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-2 col-form-label">Added Time</label>
                    <div class="col-10">
                        <input disabled class="form-control line_i" name="AddedTime" type="text"
                            value="{{ $department['AddedTime'] }}" />
